// RentalRMS Service Worker v4.6.4
// Payment Status Fix: Exclude Conditional Payments, Period Date Alignment, Platform Payout Logic
const CACHE_VERSION = '4.6.4';
const CACHE_NAME = `rentalrms-v${CACHE_VERSION}`;

const ASSETS = [
  './',
  './index.html?v=4.6.4',
  './manifest.json?v=4.6.4',
];
