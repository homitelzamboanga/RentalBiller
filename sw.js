// RentalRMS Service Worker v4.5.2
// Platform Payout Settlement Detection, Smart 'Payment Settled' Label & All Previous Features
const CACHE_VERSION = '4.5.2';
const CACHE_NAME = `rentalrms-v${CACHE_VERSION}`;

const ASSETS = [
  './',
  './index.html?v=4.5.2',
  './manifest.json?v=4.5.2',
];
