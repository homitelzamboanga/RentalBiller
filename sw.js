// RentalRMS Service Worker v4.5.1
// Analytics & Dashboard Accuracy Fixes, Payment Compliance Fix, Revenue Calculation Fix & All Previous Features
const CACHE_VERSION = '4.5.1';
const CACHE_NAME = `rentalrms-v${CACHE_VERSION}`;

const ASSETS = [
  './',
  './index.html?v=4.5.1',
  './manifest.json?v=4.5.1',
];
